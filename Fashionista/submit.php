...
if (isset($_POST['submit'])) {
    ...
    $to = "breakingmedia@theygsgroup.com";
    // $to= "scott.johnson@theygsgroup.com";
    $headers= "From: breakingmedia@theygsgroup.com \r\n" . "Reply-To: breakingmedia@theygsgroup.com\r\n";
    $email_subject= "Breaking Media form submission";
    $email_body= "You have received a form submission from Breaking Media (breakingmedialicensing.com/Fashionista).\r\n";
